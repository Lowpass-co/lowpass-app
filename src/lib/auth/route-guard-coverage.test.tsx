...
const UNGUARDED: Record<string, string> = {
  ...
  /* ── P0-C2 — 24 routes ── */
  '/artists': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/artists/[id]': /* DELETE,PATCH */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/artists/[id]/image/[kind]': /* DELETE,POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/routing/[tourId]/export/pdf': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/routing/[tourId]/export/preview': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tour-personnel/[id]': /* DELETE,PATCH */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]': /* DELETE,PATCH */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/advance': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/advance/[routingId]': /* DELETE,PATCH */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/advance/[routingId]/share-link': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/advance/copy': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/advance/form-templates': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/payroll/finalize': /* DELETE,POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/personnel': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/personnel/[memberId]': /* DELETE,PATCH */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/personnel/[memberId]/rates': /* PUT */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/personnel/[memberId]/swap': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/personnel/conflicts': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/role-links': /* DELETE,POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/roles': /* DELETE,POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/routing': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/routing/[routingId]': /* PATCH */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
  '/tours/[id]/touch': /* POST */ 'PENDING P0-C2 — artist/tour/routing write — the demonstrated bug.',
