/* ============================================
   LOWPASS — POST /api/routing/[tourId]/export/preview  (#8 Template Builder)

   Returns the SAME document HTML the PDF route prints (buildRoutingExport), as
...
export async function POST(
  ...
  try {
    ...
    const { html } = await buildRoutingExport(
      supabase,
    ...
    return exportErrorResponse('routing-preview', err);
  }
}
