/* ============================================
   LOWPASS — Tour Secondary Card (Phase C nav redesign)

   Small build-once card for the Tour Hub bottom row. Title + a
   single sub-line (count or status). Click → tour-internal page.
   ============================================ */
