...
export function HeaderArtistTourPicker() {
  ...
  if (!hydrated) {
    return (
      <div className="flex min-w-0 w-full max-w-2xl flex-1 items-center gap-3 sm:max-w-3xl" aria-hidden>
        ...
        <div className="h-10 w-10 shrink-0 rounded-lg bg-lp-surface/60" />
        <div className="h-8 min-w-0 flex-1 rounded-md bg-lp-surface/40" />
  ...
  return (
    <div className="flex min-w-0 w-full max-w-2xl flex-1 items-center gap-3 sm:max-w-3xl">
      ...
      <div
        className="relative h-10 w-10 shrink-0 overflow-hidden rounded-lg ring-1 ring-lp-border"
      ...
      <Link
        href="/artists"
        className="flex shrink-0 items-center rounded-lg border border-lp-orange px-3 py-2 text-xs font-bold uppercase tracking-wider text-lp-orange transition-colors duration-200 hover:bg-lp-orange hover:text-white dark:hover:text-black"
